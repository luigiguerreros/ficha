...
class TiposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo" do
    assert_difference('Tipo.count') do
      post tipos_url, params: { tipo: { descripcion: @tipo.descripcion, nombre_tipo: @tipo.nombre_tipo } }
    end
  ...
  test "should update tipo" do
    patch tipo_url(@tipo), params: { tipo: { descripcion: @tipo.descripcion, nombre_tipo: @tipo.nombre_tipo } }
